...
response = openapi.get("/v1.0/users/az1582815938108xjA27/devices")    #openapi.get("/v1.0/users/az1582815938108xjA27/devices")
# print(type(response))
#device stage right eb5ee08fd7cdd8a8584g06
...
"""for i in response['result']:  
    ...
    #print(i['name'])
    if i['product_name'] == "PIR":
    #   print("PIR Sensors Here")
        print(i['name'])
        print("PIR")
        print(i['model'])
        print("\n")
    elif i['product_name'] == "PIR Sensor ":
        print(i['name'])
        print("PIR Sensor")
        print(i['model'])
        print("\n")
    elif i['product_name'] == "Smart Bulb-SL10":
        #   print("PIR Sensors Here")
        print(i['name'])
        print("LED Bulb TreatLife")
        print(i['model'])
        print("\n")
    elif i['product_name'] == "120V A19 9W SMART BULB":
        #   print("PIR Sensors Here")
        print(i['name'])
        print("LED Bulb DayBetter")
        print(i['model'])
        print("\n")
    elif i['product_name'] == "Smart Light Switch":
        #   print("PIR Sensors Here")
        print(i['name'])
        print("Switches")
        print(i['model'])
        print("\n")
    elif i['product_name'] == "SS01S Smart Light Switch1":
        #   print("PIR Sensors Here")
        print(i['name'])
        print("Switches 1 TreatLife")
        print(i['model'])
        print("\n")
    elif i['product_name'] == "DS01C Smart dimmer switch":
        #   print("PIR Sensors Here")
        print(i['name'])
        print("Dimmer Switches TreatLife")
        print(i['model'])
        print("\n")
    elif i['product_name'] == "WiFi switch-4CH":
        #   print("PIR Sensors Here")
        print("Four Channel Relay Board Smart Home")
        print(i['model'])
        print("\n") 
    else:
        pass"""
